...
<head>
    ...
    <meta charset="utf-8">
    <title>Splash Mountain Legacy - Temporarily Unavailable</title>
    ...
    <link rel="stylesheet" href="/unavailable/styles.css">
...
<body ontouchstart class>
    ...
    <main>
        <section>
            <h1 class="quote">We'll Be Right Back</h1>
            <h3 class="subquote">Restricted</h3>
        ...
        var options = [
            {
                ...
                description: "We're busy upgrading Legacy to make it even better for you. Please try again in a minute.",
                link: "Retry"
            },
            {
