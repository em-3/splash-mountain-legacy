...
function addContentField(type) {
  contentFields.push(type.constructor());
  document
...
function showArticleDetails(articleDetails) {
  ...
  properties.push({
    ...
    constructor: function () {
      ...
      dateInput.id = "date";
      if (mode === "editor") {
        dateInput.value = new Date(itemDetails.publication_timestamp)
          .toString()
          .substring(0, 10);
      }
      ...
      timeInput.id = "time";
      if (mode === "editor") {
        timeInput.value = new Date(itemDetails.publication_timestamp)
          .toString()
          .substring(11, 16);
      }
  ...
  if (mode === "editor") {
    ...
    for (var i = 0; i < articleDetails.content.length; i++) {}
  }
