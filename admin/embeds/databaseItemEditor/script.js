...
function showItemDetails(itemDetails) {
    ...
    properties.push({
        ...
        constructor: function () {
            ...
            if (mode === "editor") { select.value = itemDetails.park.toLowerCase(); }
    ...
    properties.push({
        ...
        constructor: function () {
            ...
            input.name = "name";
            input.id = "name";
            if (mode === "editor") { input.value = itemDetails.name; }
            container.appendChild(label);
            container.appendChild(input);
            return container;
        },
    ...
    properties.push({
        ...
        constructor: function () {
            ...
            if (mode === "editor") { input.value = itemDetails.description; }
            container.appendChild(label);
            container.appendChild(input);
            return container;
        },
    ...
    properties.push({
        ...
        constructor: function () {
            ...
            if (mode === "editor" && itemDetails.author) { nameInput.value = itemDetails.author.replace(/\[.*\]/, ""); }
            ...
            if (mode === "editor" && itemDetails.author) { linkInput.value = itemDetails.author.match(/\[(.*)\]/)[0].substr(1, itemDetails.author.match(/\[(.*)\]/)[0].length - 2); }
    ...
    properties.push({
        ...
        constructor: function () {
            ...
            if (mode === "editor" && metadata.precision) { precisionSelect.value = metadata.precision };
            ...
            makeInput.name = "make";
            makeInput.id = "make";
            if (mode === "editor" && metadata.make) { makeInput.value = metadata.make };
            ...
            modelInput.id = "model";
            if (mode === "editor" && metadata.model) { modelInput.value = metadata.model };
            ...
            if (mode === "editor" && metadata.focalLength) { focalLengthInput.value = metadata.focalLength };
            ...
            if (mode === "editor" && metadata.software) { softwareVersionInput.value = metadata.software };
            ...
            if (mode === "editor" && metadata.exposureTime) { exposureTimeInput.value = metadata.exposureTime };
            ...
            if (mode === "editor" && metadata.fNumber) { fNumberInput.value = metadata.fNumber };
            ...
            if (mode === "editor" && metadata.flash) { flashInput.value = metadata.flash };
            ...
            if (mode === "editor" && metadata.colorSpace) { colorSpaceInput.value = metadata.colorSpace };
            ...
            if (mode === "editor" && metadata.samplingRate) { samplingRateInput.value = metadata.samplingRate };
        ...
        valueGetter: function () {
            ...
            if (elements.timestampPrecision.value) { updatedMetadata.precision = elements.timestampPrecision.value };
            if (elements.make.value) { updatedMetadata.make = elements.make.value };
            if (elements.model.value) { updatedMetadata.model = elements.model.value };

            if (!document.querySelector(".cameraInfoContainer").classList.contains("hidden")) {
                if (elements.focalLength.value) { updatedMetadata.focalLength = elements.focalLength.value };
                if (elements.softwareVersion.value) { updatedMetadata.software = elements.softwareVersion.value };
                if (elements.exposureTime.value) { updatedMetadata.exposureTime = elements.exposureTime.value };
                if (elements.fNumber.value) { updatedMetadata.fNumber = elements.fNumber.value };
                if (elements.flash.value) { updatedMetadata.flash = elements.flash.value };
                if (elements.colorSpace.value) { updatedMetadata.colorSpace = elements.colorSpace.value };
            }
