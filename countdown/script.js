...
function updateCountdown() {
    ...
    if (difference < (60 * 1000)) { // within a minute
        container.classList.add("finalCountdown")
        title.textContent = Math.ceil(difference / 1000);
    } else if (difference < (10 * 60 * 1000)) { // within 10 minutes
        title.textContent = "We're almost there!";
        subtitle.textContent = "Splash Mountain Legacy's official launch is just minutes away!";
    } else if (difference < (60 * 60 * 1000)) { // within an hour
        title.textContent = "It's almost time!";
        subtitle.textContent = "Splash Mountain Legacy is about to open its doors to Splash fans worldwide.";
    } else if (difference < (24 * 60 * 60 * 1000)) { // within a day
        title.textContent = "It's not quite time yet!";
        subtitle.textContent = "We're getting the site ready for launch!";
    } else if (difference < (7 * 24 * 60 * 60 * 1000)) { // within a week
